...
class _Settings:
    ...
    def load(self, config_path: Optional[str] = None) -> None:
        ...
        self.LLM_PROVIDER = os.getenv("LLM_PROVIDER", models.get("llm_provider", self.LLM_PROVIDER)).lower()
        ...
        self.EMBED_PROVIDER = os.getenv("EMBED_PROVIDER", rag.get("embed_provider", self.EMBED_PROVIDER)).lower()
        # DashScope API Key
